...
tic 
for j=1:Nt
    [ux,uy,a11,a12,a21,a22]=expfourier2d(x,y,L,eta,N,ranm1,ranm2,ranv1,ranv2,acent);
%     ux=0.1*ones(1,Np);
%     uy=0.1*ones(1,Np);
%     a11=0.1*ones(1,Np);
%     a12=0.1*ones(1,Np);
%     a21=0.1*ones(1,Np);
    ...
    [k1ux,k1uy,k1a11,k1a12,k1a21,k1a22]=expfourier2d(x,y,L,eta,N,ranm1,ranm2,ranv1,ranv2,acent);
    ...
    [k2ux,k2uy,k2a11,k2a12,k2a21,k2a22]=expfourier2d(x+dt*(k1ux)/2,y+dt*(k1uy)/2,L,eta,N,ranm1,ranm2,ranv1,ranv2,acent);
    ...
    [k3ux,k3uy,k3a11,k3a12,k3a21,k3a22]=expfourier2d(x+dt*(k2ux)/2,y+dt*(k2uy)/2,L,eta,N,ranm1,ranm2,ranv1,ranv2,acent);
    ...
    [k4ux,k4uy,k4a11,k4a12,k4a21,k4a22]=expfourier2d(x+dt*(k3ux),y+dt*(k3uy),L,eta,N,ranm1,ranm2,ranv1,ranv2,acent);
...
ylabel('\delta x')
xlabel('\delta \phi')%%
%loglog(dphivec,sum(P(30,:),1))
%%
loglog(dphivec,P1(21:23,:)')
hold on
loglog(dphivec,dphivec.^-1.2)
